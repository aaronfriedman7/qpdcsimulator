...
if __name__=="__main__":
    ...
    # cds = [0.0,0.05,0.1,0.15,0.2,0.25,0.5,0.75,1.0]
    cds = [0.0,0.1,0.15,0.2,0.25,0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0]
    for cd in cds:
        ...
        scriptfile.write("\nibrun python3 /scratch/"+mainpath+"/flap_ent.py -L={} -cd={}".format(Lc,cd))
        # if cd == 0.0:
            # scriptfile.write("\nibrun python3 /scratch/"+mainpath+"/flap_ent.py -L={} -cd={} -pbc=True".format(Lc,cd))
        scriptfile.write('\necho "job done"')
        scriptfile.close()
